...
public final class zg {
    ...
    public static int a(float[] fArr) {
        ...
        return Color.rgb(i(round, 0, 255), i(round2, 0, 255), i(round3, 0, 255));
    }
    ...
    public static void b(int i, int i2, int i3, float[] fArr) {
        ...
        fArr[0] = h(f7, 0.0f, 360.0f);
        fArr[1] = h(abs, 0.0f, 1.0f);
        fArr[2] = h(f6, 0.0f, 1.0f);
    }
    ...
    public static int f(int i, int i2) {
        ...
        int e = e(alpha2, alpha);
        return Color.argb(e, g(Color.red(i), alpha2, Color.red(i2), alpha, e), g(Color.green(i), alpha2, Color.green(i2), alpha, e), g(Color.blue(i), alpha2, Color.blue(i2), alpha, e));
    }
