...
public class im1 {
    ...
    public im1(Context context) {
        ...
        this.b = inflate;
        this.c = (TextView) inflate.findViewById(o11.message);
    ...
    public final void a(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        int dimensionPixelOffset = this.a.getResources().getDimensionPixelOffset(g11.tooltip_precise_anchor_threshold);
        if (view.getWidth() < dimensionPixelOffset) {
            i = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            int dimensionPixelOffset2 = this.a.getResources().getDimensionPixelOffset(g11.tooltip_precise_anchor_extra_offset);
        ...
        int dimensionPixelOffset3 = this.a.getResources().getDimensionPixelOffset(z ? g11.tooltip_y_offset_touch : g11.tooltip_y_offset_non_touch);
        View b = b(view);
        if (b == null) {
            return;
        }
