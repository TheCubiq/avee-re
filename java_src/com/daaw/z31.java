...
public class z31 implements de0 {
    ...
    /* renamed from: l */
    public final C0729a m2879l(int i) {
        C0729a c0729a = new C0729a();
        c0729a.m26739d(44100, 2, i, i);
        float f = 0.0f;
        for (int i2 = 0; i2 < c0729a.m26741b(); i2++) {
            short[] sArr = this.f34409a;
    ...
    /* renamed from: m */
    public void m2878m() {
        this.f34412d.m27210o();
    }

    /* renamed from: n */
    public void m2877n(Bitmap bitmap) {
        this.f34413e = bitmap;
        Canvas canvas = new Canvas(bitmap);
        canvas.drawColor(0, PorterDuff.Mode.CLEAR);
        this.f34410b.m7288h(canvas);
    }
}
