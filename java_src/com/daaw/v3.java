...
public class v3 {
    ...
    public v3(CheckedTextView checkedTextView) {
    ...
    */
    public void d(android.util.AttributeSet r10, int r11) {
        /*
            ...
            int r10 = com.daaw.x21.R0     // Catch: java.lang.Throwable -> L84
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L84
            if (r11 == 0) goto L3a
            int r10 = r0.n(r10, r8)     // Catch: java.lang.Throwable -> L84
            if (r10 == 0) goto L3a
            android.widget.CheckedTextView r11 = r9.a     // Catch: android.content.res.Resources.NotFoundException -> L3a java.lang.Throwable -> L84
        ...
        L3b:
            if (r10 != 0) goto L58
            int r10 = com.daaw.x21.Q0     // Catch: java.lang.Throwable -> L84
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L84
            if (r11 == 0) goto L58
            int r10 = r0.n(r10, r8)     // Catch: java.lang.Throwable -> L84
            if (r10 == 0) goto L58
            android.widget.CheckedTextView r11 = r9.a     // Catch: java.lang.Throwable -> L84
        ...
        L58:
            int r10 = com.daaw.x21.S0     // Catch: java.lang.Throwable -> L84
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L84
            if (r11 == 0) goto L69
            android.widget.CheckedTextView r11 = r9.a     // Catch: java.lang.Throwable -> L84
            android.content.res.ColorStateList r10 = r0.c(r10)     // Catch: java.lang.Throwable -> L84
            com.daaw.ye.b(r11, r10)     // Catch: java.lang.Throwable -> L84
        L69:
            int r10 = com.daaw.x21.T0     // Catch: java.lang.Throwable -> L84
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L84
            if (r11 == 0) goto L80
            android.widget.CheckedTextView r11 = r9.a     // Catch: java.lang.Throwable -> L84
            r1 = -1
            ...
            com.daaw.ye.c(r11, r10)     // Catch: java.lang.Throwable -> L84
        L80:
            r0.w()
            return
        L84:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.daaw.v3.d(android.util.AttributeSet, int):void");
    }
