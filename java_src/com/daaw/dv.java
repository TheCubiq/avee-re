    ...
    */
    public static int a(byte[] r7) {
        ...
        L63:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.daaw.dv.a(byte[]):int");
    }

    public static qv0 b(byte[] bArr) {
    ...
    public static Format g(byte[] bArr, String str, String str2, DrmInitData drmInitData) {
        ...
        b2.o(10);
        return Format.u(str, "audio/vnd.dts", null, i3, -1, i + (b2.h(2) > 0 ? 1 : 0), i2, null, drmInitData, 0, str2);
    }
}
