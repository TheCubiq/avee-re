...
/* renamed from: com.daaw.g3 */
/* loaded from: classes.dex */
public class C1358g3 {
    ...
    */
    public static Interpolator m22057a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser) {
                ...
                if (next == 2) {
                    ...
                    if (name.equals("linearInterpolator")) {
                        ...
                        if (name.equals("accelerateInterpolator")) {
                            ...
                            accelerateInterpolator = new zv0(context, asAttributeSet, xmlPullParser);
                        }
                        interpolator = accelerateInterpolator;
                    }
                }
    ...
    /* renamed from: b */
    public static Interpolator m22056b(Context context, int i) {
        ...
        try {
            try {
                ...
                Interpolator m22057a = m22057a(context, context.getResources(), context.getTheme(), animation);
                if (animation != null) {
                    animation.close();
                }
                return m22057a;
