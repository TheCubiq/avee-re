...
public class HeaderSongsViewHolder extends BaseHeaderViewHolder {
    ...
    public HeaderSongsViewHolder(Context context, ViewGroup viewGroup, IContainerData iContainerData) {
        super(UtilsUI.getInflaterFromContext(context).inflate(R.layout.header_songs_item, viewGroup, false), iContainerData);
    ...
    public void onBind(final IContainerData iContainerData, int i) {
        ...
        if (libraryContainerDataListener != null) {
            libraryContainerDataListener.subscribeWeakShowAlbumArtValueChanged(new WeakEvent1.Handler<Boolean>() { // from class: com.daaw.avee.comp.LibraryQueueUI.ViewHolders.HeaderSongsViewHolder.1
        ...
        this.buttons[0].setOnClickListener(new View.OnClickListener() { // from class: com.daaw.avee.comp.LibraryQueueUI.ViewHolders.HeaderSongsViewHolder.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                iContainerData.executeItemActionHeader(new ContextData(view), 0);
            }
        });
        this.buttons[1].setOnClickListener(new View.OnClickListener() { // from class: com.daaw.avee.comp.LibraryQueueUI.ViewHolders.HeaderSongsViewHolder.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                iContainerData.executeItemActionHeader(new ContextData(view), 1);
            }
        });
        this.buttons[2].setOnClickListener(new View.OnClickListener() { // from class: com.daaw.avee.comp.LibraryQueueUI.ViewHolders.HeaderSongsViewHolder.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                BaseHeaderViewHolder.onActionChooseSort.invoke(new ContextData(view), view);
            }
        });
        this.buttons[3].setOnClickListener(new View.OnClickListener() { // from class: com.daaw.avee.comp.LibraryQueueUI.ViewHolders.HeaderSongsViewHolder.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                BaseHeaderViewHolder.onAction.invoke(new ContextData(view), 115, view);
            }
        });
        this.buttons[4].setOnClickListener(new View.OnClickListener() { // from class: com.daaw.avee.comp.LibraryQueueUI.ViewHolders.HeaderSongsViewHolder.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
