...
public class HeaderPlainGoneViewHolder extends BaseAdsViewHolder {
    public HeaderPlainGoneViewHolder(Context context, ViewGroup viewGroup) {
        super(UtilsUI.getInflaterFromContext(context).inflate(R.layout.header_plain_gone_item, viewGroup, false), 0, false);
    }
