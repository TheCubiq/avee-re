...
public final class mq7 extends iq7 implements RandomAccess, eu7 {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (collection instanceof mq7) {
            ...
            if (Integer.MAX_VALUE - i2 >= i) {
                ...
                System.arraycopy(mq7Var.q, 0, this.q, this.r, mq7Var.r);
                this.r = i3;
                ((AbstractList) this).modCount++;
                return true;
            }
    ...
    public final /* bridge */ /* synthetic */ us7 b(int i) {
        if (i >= this.r) {
            return new mq7(Arrays.copyOf(this.q, i), this.r);
        }
