...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double mo1264elapsedNowUwyO8pc() {
        return Duration.m1294minusLRDsOJo(this.mark.mo1264elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1265plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this.mark, Duration.m1295plusLRDsOJo(this.adjustment, d), null);
    }
}
