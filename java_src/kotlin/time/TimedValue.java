...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1322copyRFiDyg4$default(TimedValue timedValue, Object obj, double d, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1324copyRFiDyg4(obj, d);
    }
    ...
    public final double m1323component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m1324copyRFiDyg4(T t, double d) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1309toStringimpl(this.duration) + ")";
    }
    ...
    public final double m1325getDurationUwyO8pc() {
        return this.duration;
    }
