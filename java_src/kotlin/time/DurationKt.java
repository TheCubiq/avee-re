...
public final class DurationKt {
    ...
    private static final double m1318timesmvk6XK0(int i, double d) {
        return Duration.m1298timesUwyO8pc(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m1317timeskIfJnKk(double d, double d2) {
        return Duration.m1297timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        return Duration.m1271constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
