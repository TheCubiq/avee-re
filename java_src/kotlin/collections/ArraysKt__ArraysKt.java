        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m523contentEqualskV0jMPg(((UByteArray) t).m89unboximpl(), ((UByteArray) t2).m89unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m520contentEqualsFGO6Aew(((UShortArray) t).m325unboximpl(), ((UShortArray) t2).m325unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m521contentEqualsKJPZfPQ(((UIntArray) t).m159unboximpl(), ((UIntArray) t2).m159unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m525contentEqualslec5QzE(((ULongArray) t).m229unboximpl(), ((ULongArray) t2).m229unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m537contentToString2csIQuQ(uByteArray != null ? uByteArray.m89unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m541contentToStringd6D3K8(uShortArray != null ? uShortArray.m325unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m540contentToStringXUkPCBk(uIntArray != null ? uIntArray.m159unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m543contentToStringuLth9ew(uLongArray != null ? uLongArray.m229unboximpl() : null));
            } else {
