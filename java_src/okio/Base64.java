...
final class Base64 {
    ...
    private static String encode(byte[] bArr, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < length; i2 += 3) {
            ...
            int i6 = i4 + 1;
            int i7 = i2 + 2;
            bArr3[i4] = bArr2[((bArr[i5] & AbstractID3v2Tag.PICTURETYPE_DURING_PERFORMANCE) << 2) | ((bArr[i7] & UByte.MAX_VALUE) >> 6)];
            i = i6 + 1;
        ...
        if (length2 == 1) {
            ...
            bArr3[i11] = bArr2[(bArr[i12] & AbstractID3v2Tag.PICTURETYPE_DURING_PERFORMANCE) << 2];
            bArr3[i11 + 1] = 61;
        }
        try {
