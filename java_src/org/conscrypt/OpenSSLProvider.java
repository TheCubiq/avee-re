...
public final class OpenSSLProvider extends Provider {
    ...
    public OpenSSLProvider(String str, boolean z, String str2) {
        ...
        put("Alg.Alias.MessageDigest.SHA", EvpMdRef.SHA1.JCA_NAME);
        put("Alg.Alias.MessageDigest.1.3.14.3.2.26", EvpMdRef.SHA1.JCA_NAME);
        put("MessageDigest.SHA-224", str4 + "OpenSSLMessageDigestJDK$SHA224");
        put("Alg.Alias.MessageDigest.SHA224", EvpMdRef.SHA224.JCA_NAME);
        put("Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.4", EvpMdRef.SHA224.JCA_NAME);
        put("MessageDigest.SHA-256", str4 + "OpenSSLMessageDigestJDK$SHA256");
        put("Alg.Alias.MessageDigest.SHA256", EvpMdRef.SHA256.JCA_NAME);
        put("Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.1", EvpMdRef.SHA256.JCA_NAME);
        put("MessageDigest.SHA-384", str4 + "OpenSSLMessageDigestJDK$SHA384");
        put("Alg.Alias.MessageDigest.SHA384", EvpMdRef.SHA384.JCA_NAME);
        put("Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.2", EvpMdRef.SHA384.JCA_NAME);
        put("MessageDigest.SHA-512", str4 + "OpenSSLMessageDigestJDK$SHA512");
        put("Alg.Alias.MessageDigest.SHA512", EvpMdRef.SHA512.JCA_NAME);
        put("Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.3", EvpMdRef.SHA512.JCA_NAME);
