...
.method public constructor <init>(Landroid/content/Context;Lcom/daaw/ey1;)V
    ...
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->q:Lcom/daaw/ey1;
...
.method public a()Z
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->q:Lcom/daaw/ey1;

    invoke-static {v0, v2}, Lcom/daaw/cj1;->i(Landroid/content/Context;Lcom/daaw/ey1;)Z
    ...
    invoke-virtual {v2}, Lcom/daaw/ey1;->o()Landroidx/work/impl/WorkDatabase;

    move-result-object v2

    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->B()Lcom/daaw/ry1;

    move-result-object v3

    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->A()Lcom/daaw/ky1;

    move-result-object v4

    invoke-virtual {v2}, Lcom/daaw/b61;->c()V

    :try_start_0
    invoke-interface {v3}, Lcom/daaw/ry1;->h()Ljava/util/List;
    ...
    check-cast v8, Lcom/daaw/qy1;

    sget-object v9, Lcom/daaw/yx1;->p:Lcom/daaw/yx1;

    new-array v10, v6, [Ljava/lang/String;

    iget-object v11, v8, Lcom/daaw/qy1;->a:Ljava/lang/String;

    aput-object v11, v10, v1

    invoke-interface {v3, v9, v10}, Lcom/daaw/ry1;->k(Lcom/daaw/yx1;[Ljava/lang/String;)I

    iget-object v8, v8, Lcom/daaw/qy1;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v3, v8, v9, v10}, Lcom/daaw/ry1;->b(Ljava/lang/String;J)I

    goto :goto_2

    :cond_2
    invoke-interface {v4}, Lcom/daaw/ky1;->c()V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->q:Lcom/daaw/ey1;

    invoke-virtual {v0}, Lcom/daaw/ey1;->s()V

    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->q:Lcom/daaw/ey1;

    invoke-virtual {v0}, Lcom/daaw/ey1;->l()Lcom/daaw/zy0;

    move-result-object v0

    invoke-virtual {v0, v2}, Lcom/daaw/zy0;->c(Z)V
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->q:Lcom/daaw/ey1;

    invoke-virtual {v1}, Lcom/daaw/ey1;->o()Landroidx/work/impl/WorkDatabase;

    move-result-object v1

    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->q:Lcom/daaw/ey1;

    invoke-virtual {v2}, Lcom/daaw/ey1;->n()Ljava/util/List;
...
.method public e()Z
    ...
    invoke-virtual {v3, v4, v0, v5}, Lcom/daaw/ll0;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method public f()Z
    ...
    :cond_0
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->p:Landroid/content/Context;
    ...
    invoke-virtual {v1, v4, v2, v3}, Lcom/daaw/ll0;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method public h()Z
    ...
    invoke-virtual {v0}, Lcom/daaw/zy0;->a()Z
...
.method public run()V
    ...
    invoke-virtual {v0}, Lcom/daaw/ey1;->r()V
    ...
    invoke-static {v0}, Lcom/daaw/vx1;->e(Landroid/content/Context;)V
    ...
    :goto_1
    :try_start_3
    iget v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->r:I

    const/4 v2, 0x1

    add-int/2addr v1, v2

    iput v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->r:I
    ...
    invoke-virtual {v4, v5, v1, v6}, Lcom/daaw/ll0;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0}, Landroidx/work/a;->d()Lcom/daaw/vf0;
    ...
    invoke-virtual {v1, v5, v6, v2}, Lcom/daaw/ll0;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    invoke-interface {v0, v4}, Lcom/daaw/vf0;->a(Ljava/lang/Throwable;)V
    :try_end_3
    ...
    invoke-virtual {v1, v8, v4, v2}, Lcom/daaw/ll0;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    iget v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->r:I
    ...
    invoke-virtual {v1}, Lcom/daaw/ey1;->r()V
